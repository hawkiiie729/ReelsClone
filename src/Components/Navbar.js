...
const useStyles=makeStyles({ //material ui k components ko design  krne ka tarkia 
   appb:{
     background :'white'
   }
})
      ...
      <AppBar position="fixed" sx={{background:'white'}} >
        <Toolbar>
          <div style={{marginLeft:'5%'}}>
           ...
           <img src={insta} style={{width:'25vh'}} onClick={handlebannerclick}></img>

          </div>
          
          <Box sx={{ flexGrow: 1 }} />
          <Box sx={{ display: { xs: 'none', md: 'flex' },color:'black',alignItems:'center',marginRight:'4rem' }}>
          <HomeIcon onClick={handlebannerclick} sx={{marginRight:'2rem',cursor:'pointer',fontSize:'2rem'}}/>
         
          <ExploreIcon onClick={handleexplore} sx={{marginRight:'1.5rem',cursor:'pointer',fontSize:'2rem'}}/>
            <IconButton
              size="large"
              edge="end"
